...
<aside class="w-64 bg-slate-900 border-r border-slate-800 flex flex-col flex-shrink-0 min-h-screen">
    ...
    <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        ...
        {{-- Divider WiFi --}}
        <div class="pb-1">
            <p class="px-3 text-xs font-semibold text-slate-600 uppercase tracking-wider">Layanan WiFi</p>
        </div>
        ...
        {{-- Nota Custom --}}
        <div class="pt-3 pb-1">
            <p class="px-3 text-xs font-semibold text-slate-600 uppercase tracking-wider">Non-WiFi</p>
        </div>
